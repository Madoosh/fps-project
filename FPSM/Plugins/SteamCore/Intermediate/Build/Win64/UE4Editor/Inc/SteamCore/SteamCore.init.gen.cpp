	...
	UPackage* Z_Construct_UPackage__Script_SteamCore()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServersUpdated__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_SteamCore_OnServersFinishedAsyncDelegate__DelegateSignature,
