...
class STEAMCORE_API UUser : public USteamCoreSubsystem
{
	GENERATED_BODY()
public:
	UUser() {SubsystemType = ESubsystem::User;}
public:
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "SteamCore|User")
		static ESteamVoiceResult DecompressVoice(TArray<uint8> compressedBuffer, int32 desiredSampleRate, TArray<uint8>& destBuffer);
