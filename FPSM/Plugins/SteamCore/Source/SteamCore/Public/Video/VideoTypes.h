...
public:
	...
	FGetOPFSettingsResult(const GetOPFSettingsResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), AppID(data.m_unVideoAppID)
	{}
};
...
public:
	...
	FGetVideoURLResult(const GetVideoURLResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), AppID(data.m_unVideoAppID), URL(UTF8_TO_TCHAR(data.m_rgchURL))
	{}
};
