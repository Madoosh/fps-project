...
public:
	...
	FCreateItemResult(const CreateItemResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), PublishedFileID(data.m_nPublishedFileId), bUserNeedsToAcceptWorkshopLegalAgreement(data.m_bUserNeedsToAcceptWorkshopLegalAgreement)
	{}
};
...
public:
	...
	FUserFavoriteItemsListChanged(const UserFavoriteItemsListChanged_t& data)
		: PublishedFileID(data.m_nPublishedFileId), Result(static_cast<ESteamResult>(data.m_eResult)), bWasAddRequest(data.m_bWasAddRequest)
	{}
};
...
public:
	...
	FGetUserItemVoteResult(const GetUserItemVoteResult_t& data)
		: PublishedFileID(data.m_nPublishedFileId), Result(static_cast<ESteamResult>(data.m_eResult)), bVotedUp(data.m_bVotedUp),
...
public:
	...
	FSetUserItemVoteResult(const SetUserItemVoteResult_t& data)
		: PublishedFileID(data.m_nPublishedFileId), Result(static_cast<ESteamResult>(data.m_eResult)), bVoteUp(data.m_bVoteUp)
	{}
};
...
public:
	...
	FSubmitItemUpdateResult(const SubmitItemUpdateResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), bUserNeedsToAcceptWorkshopLegalAgreement(data.m_bUserNeedsToAcceptWorkshopLegalAgreement), PublishedFileID(data.m_nPublishedFileId)
	{}
};
...
public:
	...
	FDownloadItemResult(const DownloadItemResult_t& data)
		: AppID(data.m_unAppID), PublishedFileID(data.m_nPublishedFileId), Result(static_cast<ESteamResult>(data.m_eResult))
	{}
};
...
public:
	...
	FSteamUGCQueryCompleted(const SteamUGCQueryCompleted_t& data)
		: Handle(data.m_handle), Result(static_cast<ESteamResult>(data.m_eResult)), NumResultsReturned(data.m_unNumResultsReturned), TotalMatchingResults(data.m_unTotalMatchingResults), bCachedData(data.m_bCachedData)
	{}
};
...
public:
	...
	FAddAppDependencyResult(const AddAppDependencyResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), PublishedFileID(data.m_nPublishedFileId), AppID(data.m_nAppID)
	{}
};
...
public:
	...
	FAddUGCDependencyResult(const AddUGCDependencyResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), PublishedFileId(data.m_nPublishedFileId), ChildPublishedFileId(data.m_nChildPublishedFileId)
	{}
};
...
public:
	...
	FDeleteItemResult(const DeleteItemResult_t& data)
...
public:
	...
	FGetAppDependenciesResult(const GetAppDependenciesResult_t& data)
		: Result(static_cast<ESteamResult>(data.m_eResult)), PublishedFileID(data.m_nPublishedFileId), NumAppDependencies(data.m_nNumAppDependencies), TotalNumAppDependencies(data.m_nTotalNumAppDependencies)
	{
...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FOnDeleteItemResult, const FDeleteItemResult&, data, bool, bWasSuccessful);
