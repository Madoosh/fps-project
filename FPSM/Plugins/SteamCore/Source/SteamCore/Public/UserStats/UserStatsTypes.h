...
#include "UserStatsTypes.generated.h"
...
public:
	...
	FUserStatsReceived(const UserStatsReceived_t& data)
		: GameID(data.m_nGameID), Result(static_cast<ESteamResult>(data.m_eResult)), SteamID(data.m_steamIDUser)
	{}
};
...
public:
	...
	FUserStatsStored(const UserStatsStored_t& data)
		: GameID(data.m_nGameID), Result(static_cast<ESteamResult>(data.m_eResult))
	{}
};
...
public:
	...
	FRequestUserStatsData(const UserStatsReceived_t& data)
		: GameID(data.m_nGameID), Result(static_cast<ESteamResult>(data.m_eResult)), SteamIDUser(data.m_steamIDUser)
	{}
};
...
public:
	...
	FAttachLeaderboardUGCData(const LeaderboardUGCSet_t& data)
		: SteamLeaderboard(data.m_hSteamLeaderboard), Result(static_cast<ESteamResult>(data.m_eResult))
	{}
};
