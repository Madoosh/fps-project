...
void FAnimNode_LandFootIK::PreUpdate(const UAnimInstance* InAnimInstance)
{
	...
	bCanLand &= PredictLandingLocation(PredictResult);

	FHitResult& Hit = PredictResult.HitResult;
...
bool FAnimNode_LandFootIK::PredictLandingLocation(FPredictProjectilePathResult& OutPredictResult)
{
