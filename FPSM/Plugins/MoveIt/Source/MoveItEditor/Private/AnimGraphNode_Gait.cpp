...
{
	return LOCTEXT("AnimGraphNode_Gait_Tooltip", "Changes the distance between the feet while moving, providing free start and stop animations. Applies a spring to the pelvis to modify the character's motion weight at shorter gaits.");
}
